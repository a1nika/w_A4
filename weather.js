...
const API_KEY = 'c692a4f49344c3980faa95a3d5ef58b5';
setInterval(() =>{
    const time = new Date();
...
function showWeatherData (data){
    ...
    `;
    const otherDayForcast = data.daily;
    ...
    showWeatherData(humidity, pressure, sunrise, sunset, wind_speed, dailyForecast);
}